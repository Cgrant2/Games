...
__function_mkprojectile:
  ...
  mov [R1], R0
  mov R0, [BP-1]
__function_mkprojectile_return:
  iadd SP, 1
  pop R2
  pop R1
  mov SP, BP
...
__if_2125_else:
  ...
  mov [BP-1], R0
__while_2146_start:
__while_2146_continue:
  mov R1, [BP-1]
  iadd R1, 7
  mov R0, [R1]
  mov R1, [BP+3]
  ine R0, R1
  jf R0, __while_2146_end
  mov R1, [BP-1]
  iadd R1, 7
  mov R0, [R1]
  mov [BP-1], R0
  jmp __while_2146_start
__while_2146_end:
  mov R1, [BP-1]
  iadd R1, 7
  mov R0, [R1]
...
__while_2242_continue:
  ...
  mov R1, [R1]
  ine R0, R1
  jf R0, __while_2242_end
  mov R1, [BP-1]
  iadd R1, 7
  mov R0, [R1]
  mov [BP-1], R0
  jmp __while_2242_start
__while_2242_end:
  mov R1, [BP+3]
  mov R1, [R1]
  iadd R1, 7
...
__function_clearlist:
  ...
  mov [BP-3], R0
__while_2281_start:
__while_2281_continue:
  mov R0, [BP-1]
  ine R0, -1
  jf R0, __while_2281_end
  mov R1, [BP+2]
  mov [SP], R1
  mov R1, [BP-3]
  mov [SP+1], R1
...
__while_2396_start:
__while_2396_continue:
  call __function_gamepad_button_x
  mov R1, R0
  ilt R1, 0
  jf R1, __LogicalAnd_ShortCircuit_2401
  call __function_gamepad_button_a
  mov R2, R0
  ilt R2, 0
  and R1, R2
__LogicalAnd_ShortCircuit_2401:
  mov R0, R1
  jf R0, __while_2396_end
  mov R1, -16777216
  mov [SP], R1
...
__while_2621_start:
__while_2621_continue:
  mov R0, [BP-3]
  jf R0, __LogicalAnd_ShortCircuit_2623
  mov R1, [BP-15]
  bnot R1
  and R0, R1
__LogicalAnd_ShortCircuit_2623:
  jf R0, __while_2621_end
  lea R1, [BP-16]
  mov [SP], R1
  lea R1, [BP-17]
  mov [SP+1], R1
...
__if_2669_start:
  ...
  mov R1, R0
  igt R1, 0
  jf R1, __LogicalAnd_ShortCircuit_2674
  mov R2, [BP-7]
  ile R2, 0
  and R1, R2
__LogicalAnd_ShortCircuit_2674:
  jf R1, __LogicalAnd_ShortCircuit_2679
  mov R3, [BP-14]
  iadd R3, 2
  mov R2, [R3]
  mov R3, [BP-2]
  ilt R2, R3
  and R1, R2
__LogicalAnd_ShortCircuit_2679:
  mov R0, R1
  jf R0, __if_2669_end
__if_2683_start:
  mov R0, [BP-1]
...
__if_2669_end:
  ...
  mov [BP-12], R0
__while_2724_start:
__while_2724_continue:
  mov R0, [BP-12]
  ine R0, -1
  jf R0, __while_2724_end
  mov R1, [BP-12]
  iadd R1, 2
  mov R0, [R1]
  mov R2, [BP-12]
...
__if_2736_end:
  ...
  mov R0, [R1]
  mov [BP-12], R0
  jmp __while_2724_start
__while_2724_end:
  mov R1, [BP-13]
  mov R0, [R1]
  mov [BP-9], R0
__while_2759_start:
__while_2759_continue:
  mov R0, [BP-9]
  ine R0, -1
  jf R0, __while_2759_end
__if_2764_start:
  mov R1, [BP-9]
  iadd R1, 3
  mov R0, [R1]
...
__if_2793_start:
  ...
  mov R0, [R1]
  ile R0, 0
  jf R0, __LogicalAnd_ShortCircuit_2802
  mov R3, [BP-9]
  iadd R3, 6
  mov R2, [R3]
  mov R1, [R2]
  bnot R1
  and R0, R1
__LogicalAnd_ShortCircuit_2802:
  jf R0, __if_2793_else
  mov R1, [BP-9]
  iadd R1, 1
  mov R0, [R1]
  mov R2, [BP-9]
...
__if_2862_start:
  ...
  mov R0, [R1]
  igt R0, 625
  jt R0, __LogicalOr_ShortCircuit_2871
  mov R2, [BP-9]
  iadd R2, 1
  mov R1, [R2]
  ilt R1, 15
  or R0, R1
__LogicalOr_ShortCircuit_2871:
  jf R0, __if_2862_end
  mov R1, [BP-13]
  mov R0, [R1]
  mov [BP-10], R0
__while_2879_start:
__while_2879_continue:
  mov R0, [BP-10]
  ine R0, -1
  jf R0, __while_2879_end
  mov R1, [BP-10]
  iadd R1, 2
  mov R0, [R1]
  iadd R0, 30
...
__if_2926_start:
  ...
  mov R1, [BP-5]
  ieq R0, R1
  jf R0, __LogicalAnd_ShortCircuit_2935
  mov R3, [BP-9]
  iadd R3, 6
  mov R2, [R3]
  mov R1, [R2]
  and R0, R1
__LogicalAnd_ShortCircuit_2935:
  jf R0, __if_2926_end
__if_2937_start:
  mov R2, [BP-9]
  iadd R2, 6
  ...
  isub R1, 30
  igt R0, R1
  jf R0, __LogicalAnd_ShortCircuit_2948
  mov R3, [BP-9]
  iadd R3, 6
  mov R2, [R3]
  iadd R2, 1
  ...
  ilt R1, R2
  and R0, R1
__LogicalAnd_ShortCircuit_2948:
  jf R0, __if_2937_end
  mov R0, 0
  mov R2, [BP-9]
  iadd R2, 6
...
__if_2926_end:
  ...
  mov [BP-11], R0
__while_2966_start:
__while_2966_continue:
  mov R0, [BP-11]
  ine R0, -1
  jf R0, __while_2966_end
__if_2971_start:
  mov R1, [BP-11]
  iadd R1, 2
  mov R0, [R1]
  ...
  mov R1, [R2]
  ieq R0, R1
  jf R0, __LogicalAnd_ShortCircuit_2978
  mov R1, [BP-11]
  ine R1, -1
  and R0, R1
__LogicalAnd_ShortCircuit_2978:
  jf R0, __if_2971_end
__if_2982_start:
  mov R1, [BP-11]
  iadd R1, 1
  ...
  isub R1, 13
  igt R0, R1
  jf R0, __LogicalAnd_ShortCircuit_2992
  mov R2, [BP-11]
  iadd R2, 1
  mov R1, [R2]
  mov R3, [BP-9]
  ...
  ilt R1, R2
  and R0, R1
__LogicalAnd_ShortCircuit_2992:
  jf R0, __if_2982_end
  mov R0, [BP-11]
  mov [BP-18], R0
  mov R1, [BP-11]
...
__if_2971_end:
  ...
  mov R0, [R1]
  mov [BP-11], R0
  jmp __while_2966_start
__while_2966_end:
  mov R1, [BP-9]
  iadd R1, 7
  mov R0, [R1]
  mov [BP-9], R0
  jmp __while_2759_start
__while_2759_end:
  mov R1, -16777216
  mov [SP], R1
  call __function_clear_screen
...
__if_3038_start:
  ...
  imod R1, 20
  ilt R1, 5
  jf R1, __LogicalAnd_ShortCircuit_3045
  call __function_get_frame_counter
  mov R2, R0
  imod R2, 20
  ige R2, 0
  and R1, R2
__LogicalAnd_ShortCircuit_3045:
  mov R0, R1
  jf R0, __if_3038_else
  mov R1, 0
  mov [SP], R1
  call __function_select_region
  jmp __if_3038_end
...
__if_3053_start:
  ...
  imod R1, 20
  ilt R1, 11
  jf R1, __LogicalAnd_ShortCircuit_3060
  call __function_get_frame_counter
  mov R2, R0
  imod R2, 20
  ige R2, 5
  and R1, R2
__LogicalAnd_ShortCircuit_3060:
  mov R0, R1
  jf R0, __if_3053_else
  mov R1, 1
  mov [SP], R1
  call __function_select_region
  jmp __if_3053_end
...
__if_3068_start:
  ...
  imod R1, 20
  ilt R1, 21
  jf R1, __LogicalAnd_ShortCircuit_3075
  call __function_get_frame_counter
  mov R2, R0
  imod R2, 20
  ige R2, 15
  and R1, R2
__LogicalAnd_ShortCircuit_3075:
  mov R0, R1
  jf R0, __if_3068_else
  mov R1, 1
  mov [SP], R1
  call __function_select_region
  jmp __if_3068_end
...
__if_3083_start:
  ...
  imod R1, 20
  ilt R1, 16
  jf R1, __LogicalAnd_ShortCircuit_3090
  call __function_get_frame_counter
  mov R2, R0
  imod R2, 20
  ige R2, 10
  and R1, R2
__LogicalAnd_ShortCircuit_3090:
  mov R0, R1
  jf R0, __if_3083_end
  mov R1, 2
  mov [SP], R1
...
__if_3101_end:
  ...
  mov [BP-11], R0
__while_3115_start:
__while_3115_continue:
  mov R0, [BP-11]
  ine R0, -1
  jf R0, __while_3115_end
  mov R2, [BP-11]
  iadd R2, 1
  mov R1, [R2]
  mov [SP], R1
  ...
  mov R0, [R1]
  mov [BP-11], R0
  jmp __while_3115_start
__while_3115_end:
  mov R1, [BP-13]
  mov R0, [R1]
  mov [BP-9], R0
__while_3133_start:
__while_3133_continue:
  mov R0, [BP-9]
  ine R0, -1
  jf R0, __while_3133_end
  mov R1, 1
  mov [SP], R1
  call __function_select_texture
__if_3140_start:
...
__if_3191_end:
  call __function_end_frame
  jmp __while_2621_start
__while_2621_end:
__while_3202_start:
__while_3202_continue:
  mov R0, 1
  jf R0, __while_3202_end
__if_3205_start:
  mov R0, [BP-15]
  jf R0, __if_3205_else
  mov R1, -16777216
  mov [SP], R1
  call __function_clear_screen
  mov R1, 320
...
__if_3205_else:
  ...
  mov [SP+1], R1
  call __function_set_drawing_point
  mov R1, __literal_string_3230
  mov [SP], R1
  call __function_print
__if_3205_end:
  jmp __while_3202_start
__while_3202_end:
...
__literal_string_1917:
  string "0"
__literal_string_2415:
  string "Use Left/Right to move and Space to shoot"
__literal_string_2426:
  string "Press E to begin in easy mode =)"
__literal_string_2437:
  string "Press H to begin in hard mode =)"
__literal_string_3218:
  string "You are win =)"
__literal_string_3230:
  string "L bozo"
