...
__if_2427_start:
  mov R0, [BP+3]
  ine R0, -1
  jf R0, __LogicalAnd_ShortCircuit_2434
  mov R3, [BP+2]
  iadd R3, 1
  mov R2, [R3]
  iadd R2, 2
  ...
  ilt R1, R2
  and R0, R1
__LogicalAnd_ShortCircuit_2434:
  jf R0, __if_2427_end
  mov R3, [BP+2]
  iadd R3, 1
  mov R2, [R3]
...
__function_clearstacklist:
  ...
  mov [BP-3], R0
__while_2739_start:
__while_2739_continue:
  mov R0, [BP-1]
  ine R0, -1
  jf R0, __while_2739_end
  mov R2, [BP+2]
  mov [SP], R2
  mov R2, [BP-3]
  mov [SP+1], R2
...
__function_shuffle:
  ...
  mov [BP-2], R0
__while_2802_start:
__while_2802_continue:
  mov R0, [BP-2]
  ine R0, -1
  jf R0, __while_2802_end
  mov R2, [BP+2]
  mov [SP], R2
  lea R2, [BP-2]
  mov [SP+1], R2
  ...
  mov R0, [R1]
  mov [BP-2], R0
  jmp __while_2802_start
__while_2802_end:
__while_2824_start:
__while_2824_continue:
  mov R1, [BP-1]
  iadd R1, 2
  mov R0, [R1]
  igt R0, 0
  jf R0, __while_2824_end
  mov R1, [BP-1]
  mov R0, [R1]
  mov [BP-2], R0
  ...
  mov R0, R1
__while_2841_start:
__while_2841_continue:
  mov R0, [BP-3]
  igt R0, 0
  jf R0, __while_2841_end
  mov R1, [BP-2]
  mov R0, [R1]
  mov [BP-2], R0
  mov R0, [BP-3]
...
__for_2992_start:
  mov R0, [BP-1]
  ilt R0, 52
  jf R0, __for_2992_end
__if_3002_start:
  mov R0, [BP-1]
  imod R0, 13
  ieq R0, 0
  jf R0, __LogicalAnd_ShortCircuit_3010
  mov R1, [BP-1]
  ine R1, 0
  and R0, R1
__LogicalAnd_ShortCircuit_3010:
  jf R0, __if_3002_end
  mov R0, [BP-20]
  mov R1, R0
  iadd R1, 1
...
__for_3178_continue:
  ...
  iadd R1, 1
  mov [BP-1], R1
  jmp __for_3178_start
__for_3178_end:
__while_3203_start:
__while_3203_continue:
  call __function_gamepad_button_b
  mov R1, R0
  ile R1, 0
  mov R0, R1
  jf R0, __while_3203_end
  mov R1, 0
  mov [SP], R1
  call __function_select_texture
  mov R1, 0
  ...
  mov [SP+1], R1
  call __function_set_drawing_point
  mov R1, __literal_string_3239
  mov [SP], R1
  call __function_print
  mov R0, 30
  mov [BP-5], R0
  jmp __while_3203_start
__while_3203_end:
  mov R0, 0
  mov [BP-7], R0
__while_3246_start:
__while_3246_continue:
  mov R0, 1
  jf R0, __while_3246_end
  mov R1, [BP-21]
  mov R0, [R1]
  mov [BP-16], R0
  mov R0, 0
...
__if_3273_start:
  ...
  mov R1, R0
  igt R1, 0
  jf R1, __LogicalAnd_ShortCircuit_3278
  mov R2, [BP-5]
  ile R2, 0
  and R1, R2
__LogicalAnd_ShortCircuit_3278:
  jf R1, __LogicalAnd_ShortCircuit_3282
  mov R2, [BP-6]
  igt R2, 0
  and R1, R2
__LogicalAnd_ShortCircuit_3282:
  mov R0, R1
...
__if_3305_start:
  ...
  mov R1, R0
  igt R1, 0
  jf R1, __LogicalAnd_ShortCircuit_3310
  mov R2, [BP-5]
  ile R2, 0
  and R1, R2
__LogicalAnd_ShortCircuit_3310:
  jf R1, __LogicalAnd_ShortCircuit_3314
  mov R2, [BP-6]
  ilt R2, 7
  and R1, R2
__LogicalAnd_ShortCircuit_3314:
  mov R0, R1
  jf R0, __if_3305_end
  mov R0, [BP-6]
  mov R1, R0
...
__if_3361_start:
  ...
  mov R1, R0
  igt R1, 0
  jf R1, __LogicalAnd_ShortCircuit_3366
  mov R2, [BP-5]
  ile R2, 0
  and R1, R2
__LogicalAnd_ShortCircuit_3366:
  jf R1, __LogicalAnd_ShortCircuit_3370
  mov R2, [BP-7]
  mov R4, [BP-16]
  iadd R4, 5
  mov R3, [R4]
  ilt R2, R3
  and R1, R2
__LogicalAnd_ShortCircuit_3370:
  mov R0, R1
  jf R0, __if_3361_end
  mov R0, [BP-7]
  mov R1, R0
...
__if_3391_start:
  ...
  mov R1, R0
  igt R1, 0
  jf R1, __LogicalAnd_ShortCircuit_3396
  mov R2, [BP-5]
  ile R2, 0
  and R1, R2
__LogicalAnd_ShortCircuit_3396:
  mov R0, R1
  jf R0, __if_3391_end
  mov R0, 0
  mov [BP-7], R0
...
__if_3406_start:
  ...
  mov R1, R0
  igt R1, 0
  jf R1, __LogicalAnd_ShortCircuit_3411
  mov R2, [BP-5]
  ile R2, 0
  and R1, R2
...
__if_3473_start:
  ...
  mov R1, R0
  igt R1, 0
  jf R1, __LogicalAnd_ShortCircuit_3478
  mov R2, [BP-5]
  ile R2, 0
  and R1, R2
__LogicalAnd_ShortCircuit_3478:
  mov R0, R1
  jf R0, __if_3473_end
__if_3482_start:
  mov R1, [BP-19]
...
__if_3498_start:
  ...
  mov R1, [R2]
  ieq R0, R1
  jf R0, __LogicalAnd_ShortCircuit_3512
  mov R2, [BP-14]
  iadd R2, 3
  mov R1, [R2]
  iadd R1, 1
  ...
  ieq R1, R2
  and R0, R1
__LogicalAnd_ShortCircuit_3512:
  jf R0, __if_3498_else
  mov R1, [BP-14]
  iadd R1, 1
  mov R0, [R1]
  mov [BP-14], R0
...
__if_3534_start:
  mov R0, [BP-12]
  jf R0, __LogicalAnd_ShortCircuit_3536
  mov R1, [BP-7]
  mov R2, [BP-8]
  ile R1, R2
  and R0, R1
__LogicalAnd_ShortCircuit_3536:
  jf R0, __if_3534_end
  mov R0, 0
  mov [BP-1], R0
__for_3541_start:
...
__if_3615_start:
  ...
  mov R1, R0
  igt R1, 0
  jf R1, __LogicalAnd_ShortCircuit_3620
  mov R2, [BP-5]
  ile R2, 0
  and R1, R2
__LogicalAnd_ShortCircuit_3620:
  mov R0, R1
  jf R0, __if_3615_end
__if_3624_start:
  mov R1, [BP-19]
  ...
  mov R0, [R1]
  ieq R0, 0
  jf R0, __LogicalAnd_ShortCircuit_3631
  mov R2, [BP-16]
  iadd R2, 5
  mov R1, [R2]
  igt R1, 0
  and R0, R1
__LogicalAnd_ShortCircuit_3631:
  jf R0, __if_3624_end
  mov R2, [BP-16]
  mov [SP], R2
  lea R2, [BP-14]
...
__if_3690_start:
  ...
  mov R1, R0
  igt R1, 0
  jf R1, __LogicalAnd_ShortCircuit_3695
  mov R2, [BP-5]
  ile R2, 0
  and R1, R2
__LogicalAnd_ShortCircuit_3695:
  mov R0, R1
  jf R0, __if_3690_end
__if_3699_start:
  mov R1, [BP-19]
...
__for_3734_continue:
  ...
  iadd R1, 1
  mov [BP-1], R1
  jmp __for_3734_start
__for_3734_end:
__if_3754_start:
  call __function_gamepad_button_y
  mov R1, R0
  igt R1, 0
  jf R1, __LogicalAnd_ShortCircuit_3759
  mov R2, [BP-5]
  ile R2, 0
  and R1, R2
__LogicalAnd_ShortCircuit_3759:
  mov R0, R1
  jf R0, __if_3754_end
__if_3763_start:
  mov R2, [BP-19]
  ...
  imod R1, 2
  ieq R0, R1
  jf R0, __LogicalAnd_ShortCircuit_3781
  mov R3, [BP-19]
  mov R2, [R3]
  iadd R2, 2
  mov R1, [R2]
  ...
  ieq R1, R2
  and R0, R1
__LogicalAnd_ShortCircuit_3781:
  jf R0, __if_3763_else
__while_3789_start:
__while_3789_continue:
  mov R1, [BP-19]
  iadd R1, 5
  mov R0, [R1]
  igt R0, 0
  jf R0, __while_3789_end
  mov R1, [BP-19]
  mov R0, [R1]
  mov [BP-14], R0
  mov R2, [BP-19]
...
__while_3822_start:
__while_3822_continue:
  mov R1, [BP-19]
  iadd R1, 5
  mov R0, [R1]
  igt R0, 0
  jf R0, __while_3822_end
  mov R1, [BP-19]
  mov R0, [R1]
  mov [BP-14], R0
  mov R2, [BP-19]
...
__if_3852_end:
__while_3914_start:
__while_3914_continue:
  mov R1, [BP-19]
  iadd R1, 5
  mov R0, [R1]
  igt R0, 0
  jf R0, __while_3914_end
  mov R1, [BP-19]
  mov R0, [R1]
  mov [BP-14], R0
  mov R2, [BP-19]
...
__if_3969_start:
  ...
  mov R1, R0
  igt R1, 0
  jf R1, __LogicalAnd_ShortCircuit_3974
  mov R2, [BP-5]
  ile R2, 0
  and R1, R2
__LogicalAnd_ShortCircuit_3974:
  mov R0, R1
  jf R0, __if_3969_end
__if_3978_start:
  mov R1, [BP-16]
  ...
  mov R0, [R1]
  ieq R0, 0
  jf R0, __LogicalAnd_ShortCircuit_3985
  mov R2, [BP-19]
  iadd R2, 5
  mov R1, [R2]
  ieq R1, 1
  and R0, R1
__LogicalAnd_ShortCircuit_3985:
  jf R0, __if_3978_else
  mov R1, [BP-19]
  mov R0, [R1]
  mov [BP-14], R0
  mov R2, [BP-19]
...
__if_4013_end:
__while_4075_start:
__while_4075_continue:
  mov R1, [BP-19]
  iadd R1, 5
  mov R0, [R1]
  igt R0, 0
  jf R0, __while_4075_end
  mov R1, [BP-19]
  mov R0, [R1]
  mov [BP-14], R0
  mov R2, [BP-19]
...
__for_4107_continue:
  ...
  iadd R1, 1
  mov [BP-1], R1
  jmp __for_4107_start
__for_4107_end:
__if_4127_start:
  call __function_gamepad_button_y
  mov R1, R0
  igt R1, 0
  jf R1, __LogicalAnd_ShortCircuit_4132
  mov R2, [BP-5]
  ile R2, 0
  and R1, R2
__LogicalAnd_ShortCircuit_4132:
  mov R0, R1
  jf R0, __if_4127_end
__if_4136_start:
  mov R1, [BP-16]
  ...
  mov R0, [R1]
  ieq R0, 0
  jf R0, __LogicalAnd_ShortCircuit_4143
  mov R2, [BP-19]
  iadd R2, 5
  mov R1, [R2]
  ieq R1, 1
  and R0, R1
__LogicalAnd_ShortCircuit_4143:
  jf R0, __if_4136_else
__if_4147_start:
  mov R2, [BP-19]
  mov R1, [R2]
  iadd R1, 2
...
__if_4181_start:
  ...
  mov R1, [R2]
  ieq R0, R1
  jf R0, __LogicalAnd_ShortCircuit_4194
  mov R3, [BP-19]
  mov R2, [R3]
  iadd R2, 3
  mov R1, [R2]
  ...
  ieq R1, R2
  and R0, R1
__LogicalAnd_ShortCircuit_4194:
  jf R0, __if_4181_end
  mov R1, [BP-19]
  mov R0, [R1]
  mov [BP-14], R0
...
__if_4222_end:
__while_4284_start:
__while_4284_continue:
  mov R1, [BP-19]
  iadd R1, 5
  mov R0, [R1]
  igt R0, 0
  jf R0, __while_4284_end
  mov R1, [BP-19]
  mov R0, [R1]
  mov [BP-14], R0
  mov R2, [BP-19]
...
__if_4513_start:
  ...
  mov R0, [R1]
  igt R0, 0
  jf R0, __if_4513_else
  mov R1, [BP-16]
  mov R0, [R1]
  mov [BP-14], R0
__while_4523_start:
__while_4523_continue:
  mov R1, [BP-14]
  iadd R1, 1
  mov R0, [R1]
  ine R0, -1
  jf R0, __while_4523_end
  mov R1, [BP-14]
  iadd R1, 1
  mov R0, [R1]
  mov [BP-14], R0
  jmp __while_4523_start
__while_4523_end:
__while_4533_start:
__while_4533_continue:
  mov R0, [BP-14]
  ine R0, -1
  jf R0, __while_4533_end
  mov R1, 3
  mov [SP], R1
  call __function_select_texture
  mov R2, [BP-14]
...
__if_4585_start:
  ...
  mov [BP-14], R0
__while_4594_start:
__while_4594_continue:
  mov R1, [BP-14]
  iadd R1, 1
  mov R0, [R1]
  ine R0, -1
  jf R0, __while_4594_end
  mov R1, [BP-14]
  iadd R1, 1
  mov R0, [R1]
  mov [BP-14], R0
  jmp __while_4594_start
__while_4594_end:
__if_4585_end:
...
__if_4704_start:
  ...
  imod R1, 60
  igt R1, 0
  jf R1, __LogicalAnd_ShortCircuit_4711
  call __function_get_frame_counter
  mov R2, R0
  imod R2, 60
  ilt R2, 45
  and R1, R2
__LogicalAnd_ShortCircuit_4711:
  mov R0, R1
  jf R0, __if_4704_end
  mov R1, [BP-3]
  mov [SP], R1
...
__if_4731_start:
  ...
  mov [BP-14], R0
__while_4741_start:
__while_4741_continue:
  mov R0, [BP-14]
  ine R0, -1
  jf R0, __while_4741_end
  mov R1, 3
  mov [SP], R1
  call __function_select_texture
  mov R2, [BP-14]
  ...
  mov R0, [R1]
  mov [BP-14], R0
  jmp __while_4741_start
__while_4741_end:
__if_4731_end:
  call __function_end_frame
  jmp __while_3246_start
__while_3246_end:
...
__literal_string_1917:
  string "0"
__literal_string_3219:
  string "Press B to start"
__literal_string_3224:
  string "Controls:"
__literal_string_3229:
  string "D-Pad - Move cursor"
__literal_string_3234:
  string "B - pick up card/stack"
__literal_string_3239:
  string "Y - place card/stack"
